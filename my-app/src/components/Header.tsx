...
const OfferTopHeader = () => {
  return (
    <div className="w-full bg-black text-white overflow-hidden">
      <div className="relative flex whitespace-nowrap">
        
        <div className="flex animate-marquee gap-16 py-2 text-sm font-medium">
          {/* Repeat content twice باش يبقى infinite smooth */}
          
          <div className="flex gap-16">
            <span>🔥 تخفيضات حتى 50% على بعض المنتجات</span>
            <span>🚚 التوصيل مجاني داخل الدار البيضاء</span>
                            ...
                            >
                                ...
                                {cart.length > 0 && (
                                    <>
                                        ...
                                        <Link
                                            href="/cart"
                                            onClick={() => setTimeout(() => setIsCartOpen(false), 300)}
                                            dir="rtl"
